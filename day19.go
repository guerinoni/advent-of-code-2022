...
func day19(input string) (int, int) {
	...
	for i, line := range lines {
		...
		part1 += blue.id * getMaxGeodes(blue, 1, 0, 0, 0, 0, 0, 0, 0, 24, cache, 0)

		if i < 3 {
			part2 *= getMaxGeodes(blue, 1, 0, 0, 0, 0, 0, 0, 0, 32, cache, 0)
		}
	}
